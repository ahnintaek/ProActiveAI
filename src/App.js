    ...
    <>
      <header>
        ...
        <div className="headerCenter">
          <div className="home">
            <button type="button headerHome">홈</button>
            <p>/</p>
            <button type="button headerPortal">포털</button>
          </div>
        ...
        <div className="headerRight">
          ...
          <button type="button">
            ...
            <span style={{marginLeft: '10px', color: '#777777'}}>KO/JP</span>
          </button>
          <button type="button">
      ...
      <main className='main_home'>
        <div className='homeSection'>
          <div className='homeSectionTop'>
            ...
            <div className="homeinputSectionV2">
            ...
            <div className="homeinputSection">
              <p className='AIInput'>무엇을 도와드릴까요?</p>
